  ...
  return (
    <>
      ...
      <div style={{ display: "flex" }}>
        ...
        <DeviceIdentifier isMobile={false} isTablet={false}>
          <nav>
            <ul id="buttons">
              <li>
              ...
              <li>
                <Collapsible trigger="Chapter 3 - JSX">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing303">
                        Listing 3-3: Custom attributes in HTML must start with
                        data-
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing304">
                        Listing 3-4: User-defined elements can have any
                        attributes
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing306">
                        Listing 3-6: Object literals in JSX result in double
                        curly braces
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing309">
                        Listing 3-9: Conditional Rendering with Element
                        Variables
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing312">
                        Listing 3-12: Using an arrow function as an event
                        handler
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 4 - All About Components">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing402">
                        Listing 4-2: Components can be imported into other
                        components
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing410">
                        Listing 4-10: Not binding your functions results in
                        errors
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing411">
                        Listing 4-11: Binding a function and using it in another
                        class
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing412">
                        Listing 4-12: Using state and setState in a Class
                        Component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing416">
                        Listing 4-16: Using props to pass data to a child
                        component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing422">
                        Listing 4-22: A component made up of three child
                        components
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing426">
                        Listing 4-26: Rendering the Children using
                        props.children
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing431">
                        Listing 4-31: A React component with a potential memory
                        leak
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 6 - React Data Flow">
                  <ul>
                    <li>
                      <Link to="/listing601">
                        Listing 6-1: Changing local variables doesn't update the
                        view
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing612">
                        Listing 6-12: Validating that a prop is an instance of a
                        class
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing614">
                        Listing 6-14: Using a Custom validator to test for a
                        phone number
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing619">
                        Listing 6-19: Setting defaultProps outside of the
                        component body
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing620">
                        Listing 6-20: Setting defaultProps for a function
                        component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing622">
                        Listing 6-22: Initializing state using the class
                        property
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing624">
                        Listing 6-24: Another Approach to Initializing State in
                    ...
                    <li>
                      <Link to="/listing626">
                        Listing 6-26: Using setState with Multiple State
                        Properties
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing627">
                        Listing 6-27: Demonstrating setState's asychronous
                        nature
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing643">
                        Listing 6-43: Adding PropTypes and Default Values to
                        InputForm
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing644">
                        Listing 6-44: RemindersList with Default Props and
                        PropTypes
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing645">
                        Listing 6-45: Validating and Setting Defaults for
                        FilterSelect
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing647">
                        Listing 6-47: The InputForm component with event
                    ...
                    <li>
                      <Link to="/listing651">
                        Listing 6-51: FilterSelect with an event handler and
                        event listener
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 7 - Events">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing703">
                        Listing 7-3: Setting an event listener in a React
                        component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing705">
                        Listing 7-5: Using an inline event handler to show an
                        alert
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing706">
                        Listing 7-6: Using an inline event handler to call
                        setState()
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing707">
                        Listing 7-7: Using an event handler function in a
                        function component
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing708">
                        Listing 7-8: Writing and binding an event handler method
                        in a class
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing711">
                        Listing 7-11: Using an arrow function as an event
                        handler
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing714">
                        Listing 7-14: Passing the Event object to the event
                        handler
                      </Link>
                    </li>
                  </ul>
              ...
              <li>
                <Collapsible trigger="Chapter 8 - Forms">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing802">
                        Listing 8-2: Adding the value attribute creates a
                        controlled input
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing803">
                        Listing 8-3: Updating an input element with one-way data
                        flow
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing809">
                        Listing 8-9: A blog comment interface using an
                        uncontrolled input
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 9 - Refs">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing905">
                        Listing 9-5: Passing a ref Callback as an Inline
                        Function
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 11 - Introducing Hooks">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing1102">
                        Listing 11-2: Setter functions are bound to their
                        creator component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1106">
                        Listing 11-6: Passing an empty array to only run
                        useEffect on mount
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1112">
                        Listing 11-12: Function dependencies cause unnecessary
                        renders
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing1113">
                        Listing 11-13: Memoized callbacks fix the unnecessary
                        effect problem
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1115">
                        Listing 11-15: Getting the value of a textarea and
                        counting its words
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1117">
                        Listing 11-17: useZipLookup: a custom hook to return
                        location data based on a zipcode
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing1118">
              ...
              <li>
                <Collapsible trigger="Chapter 12 - Routing">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing1203">
                        Listing 12-3: Using the exact attribute on NavLink
                        components
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing1204/login">
                        Listing 12-4: Multiple routes in a component may have
                        matches
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1215">
                        Listing 12-15: Viewing properties of the current
                        location object
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 13 - Error Boundaries">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing1304">
                        Listing 13-4: Logging the error and the info object to
                        the console
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1306">
                        Listing 13-6: The updated ErrorBoundary with remote
                        logging
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1308">
                        Listing 13-8: Providing a reset link in the Error
                        Boundary
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/chapter13example2">
                        Sample App with Boundary
                      </Link>
                    </li>
                  </ul>
                </Collapsible>
              ...
              <li>
                <Collapsible trigger="Chapter 16 - Fetching and Caching Data">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing1603">
                        Listing 16-3: Loading initial data in a function
                        component
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1607">
                        Listing 16-7: Writing to localStorage When the State
                        Changes
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 17 - Context API">
                  <ul>
                    ...
                    <li>
                      <Link to="/listing1706">
                        Listing 17-6: Consuming a Context in a Function
                        Component
                      </Link>
                    </li>
                    <li>
                      <Link to="/listing1707">
                        Listing 17-7: Getting Data to a Deeply-nested Component
                        with Prop Drilling
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link to="/listing1709">
                        Listing 17-9: Using a component outside of a required
                        Context
                      </Link>
                    </li>
                    <li>
              ...
              <li>
                <Collapsible trigger="Chapter 18 - React Portals">
                  <ul>
                    <li>
                      <Link to="/listing1801">
                        Listing 18-1: An HTML document with multiple nodes in
                        the body
                      </Link>
                    </li>
                    <li>
