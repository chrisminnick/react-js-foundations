function CodeLinks() {
  return (
    <>
      <p style={{backgroundColor:"#ddd",padding:"10px",fontSize:"1em"}}>
        Download the examples, report issues, and ask/answer questions
        in the discussion area by visiting the book's{" "}
