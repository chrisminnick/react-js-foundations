          ...
          <li>
            <Collapsible trigger="Chapter 6 - React Data Flow">
              <ul>
                ...
                <li>
                  <Link to="/listing647">
                    Listing 6-47: The InputForm component with event handlers
                    and event listeners
                  </Link>
                </li>
                <li>
          ...
          <li>
            <Collapsible trigger="Chapter 7 - Events">
              <ul>
                ...
                <li>
                  <Link to="/listing708">
                    Listing 7-8: Writing and binding an event handler method in
                    a class
                  </Link>
                </li>
                <li>
          ...
          <li>
            <Collapsible trigger="Chapter 11 - Introducing Hooks">
              <ul>
                ...
                <li>
                  <Link to="/listing1106">
                    Listing 11-6: Passing an empty array to only run useEffect
                    on mount
                  </Link>
                </li>
                <li>
          ...
          <li>
            <Collapsible trigger="Chapter 18 - React Portals">
              <ul>
                <li>
                  <Link to="/listing1801">
                    Listing 18-1: An HTML document with multiple nodes in the
                    body
                  </Link>
                </li>
                <li>
